    ...
    <div className="bg-slate-50">
          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <h1 className="relative w-fit tracking-tight  text-balance mt-16 font-bold !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl">
                Your Image on a{" "}
                <span className="bg-green-600 text-white px-3">Custom</span>{" "}
                Phone Case.
              </h1>
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5 mt-6">
                ...
                <div className="flex flex-col sm:justify-center items-center sm:items-start">
                  <div className="flex gap-0.5 mt-1.5">
                    <StarIcon className="text-green-600 fill-green-600" />
                    <StarIcon className="text-green-600 fill-green-600" />
                    <StarIcon className="text-green-600 fill-green-600" />
                    <StarIcon className="text-green-600 fill-green-600" />
                    <StarIcon className="text-green-600 fill-green-600" />
      ...
      <section className="bg-slate-200 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16">
          ...
          <div className="mx-auto grid  grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-3 gap-y-16">
            {/* user comment-1 */}
              ...
              <div className="flex flex-col mx-auto">
                <div className="text-lg leading-8">
                  <p className="">
                    ...
                    design.{" "}
                    <span className="font-semibold bg-slate-700 text-white px-2">
                ...
                <div className="flex gap-4 mt-2">
                  <Image
                    src="/users/user-1.png"
                    className="object-cover h-12 w-12 rounded-full ring-2"
                    alt="user image"
                    width={500}
                    height={300}
                  />
              ...
              <div className="flex flex-col mx-auto">
                <div className="text-lg leading-8">
                  <p className="">
                    ...
                    <span className="font-semibold bg-slate-700 text-white px-2">
                      The material feels premium, and the design is just
                      perfect.
                    </span>
                    "
                  </p>
              ...
              <div className="flex flex-col mx-auto">
                <div className="text-lg leading-8">
                  <p className="">
                    ...
                    <span className="font-semibold bg-slate-700 text-white px-2">
                      The colors pop, and it fits perfectly.
                    </span>
                    "
                  </p>
                </div>
      ...
      <MaxWidthWrapper className="py-24 ">
        ...
        {/* apply if needed to: ul md:-mx-0 lg:mx-12  */}
